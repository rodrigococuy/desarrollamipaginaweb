          ...
          <table class="table " border="1" >  <!--Inicio de la table    table-bordered    -->  
            ...
            */
            ...
            while($r=$products->fetch_object()):
              $prid=$r->id; 
                             ?>
                <div style="width:240px;padding:2%;display: inline-block; align:center; border:solid 1px #000; height: 415px;float:left;margin:1%; border-radius:10px;" >  <!--Inicio del col-sm-3-->  
