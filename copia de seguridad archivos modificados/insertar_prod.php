      ...
      <div class="form_head" align="left"><h2>CREAR REFERENCIAS</h2></div>
        <form method="POST" action="registra_prod.php" > 
          <table name="booklist" id="dtable" width="900">
            <thead>
              <th><p>ID.<input type="int" name="id" size="10"></p></th>
              <th><p>PRODUCTO<input type="varchar" name="name" size="25"></p></th>
              
              <div class="controls">
                <th><select name="ecategory"  id="ecategory">
                <?php
                  global $prctry;
                  ?>
              ...
              <th><p>IMAGEN<input type="int" name="foto" size="15"></p></th>
              <th><p>PRECIO<input type="int" name="price" size="15"></p></th>
              <th><p>CARACTERISTICAS<input type="varchar" name="caract1" size="254"></p></th>
            </thead>
          </table>  
