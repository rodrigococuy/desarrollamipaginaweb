...
<head>
  ...
  ?>
    ...
    <div class="container"> <br>
      <div class="form_head" align="left"><h2>VER REFERENCIAS</h2></div>
        <div class="control-group">
          <table name="booklist" id="dtable" width="900">
            ...
            <?php
              include "php/conection.php";
              $q="select cat.id_cat,cat.category,pro.id,pro.price,pro.name,pro.foto,pro.forcategoria,pro.caract1 from product pro INNER JOIN category cat ON pro.forcategoria = cat.category";
              $result = mysqli_query($con,$q);
              while($rs=mysqli_fetch_array($result)){
                $prid=$rs['id'];
                $prname=$rs['name'];
...
/*              echo "<td>".$qty."</td>"; */
                ...
                echo"<td> <a class='btn-submit' href='listar_prod.php?id=$prid' id='popedit'>Ver</a></td>";
                echo "</tr>";
              }
            ?>
          </table>
