...
<head>
  ...
  <header id="home">
    ...
    <div class="container"><br>
      <div class="form_head" align="left"><h2>CREAR CATEGORIAS</h2></div>
			  <form method="POST" action="registra_cate.php">   
          <table name="booklist" id="dtable" width="900">
            <thead>
              <th><p>ID.<input type="varchar" name="id_cat" size="12"></p></th>
              <th><p>CATEGORIA <input type="varchar" name="categoria" size="30"></p></th>
              <th><p>NIVEL <input type="int" name="id_padre" size="5"></p></th>
            </thead>
          </table>
