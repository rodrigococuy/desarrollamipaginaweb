          ...
          <table class="table " border="1" >  <!--Inicio de la table    table-bordered    -->  
            ...
            */
            ...
            while($r=$products->fetch_object()):
              $prid=$r->id; 
                             ?>
                <div style="width:180px;padding:1%;display: inline-block; align:center; border:solid 1px #000; height: 415px;float:left;margin:1%; border-radius:10px;" >  <!--Inicio del col-sm-3-->  
                  <div class="folio-item wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="300ms" style="width:100%;height:100%;"> <!--Inicio del item wow fadeInRightBig-->
                    <a href=<?php echo"'catalogo.php?id=$prid'"?>> <img class="img-responsive" src="images/portfolio/<?php echo $r->foto; ?>.png" style="width=170px;height:200px" onclick='muestro(<?php echo $r->id; ?>)'></a> <!-- Visualiza cada una de las imagenes de el catalogo-->
                      ...
                      if($found): //Valida si el producto ya fue agregado cambio el boton a el estado agregado//
                        ...
                        <form class="" method="post" action="./php/addtocart.php"> <!-- Envia por el metodo GET a el formulario addtocart los productos y la cantidad seleccionada a comprar            form-inline    -->
                          ...
                          <button type="submit" style="width:130px" class="btn btn-primary">Agregar al carrito</button>
                        </form>	
                      </div>
                                                  <?php 
                      endif; ?>
