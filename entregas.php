      ...
      <div class="control-group">  
        ...
        <table name="booklist" id="dtable" width="900">
          ...
          while($rs=mysqli_fetch_array($result)){
            ...
            ?>    
            <td>  <a class="btn-submit" href="listar_prod.php?id=<?php echo isset ($row->id);?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i>Ver</a></td>
                      <?php   
            echo "</tr>";
        ...
        <div class="folio-item wow fadeInRightBig" data-wow-duration="1000ms" data-wow-delay="300ms">
          <H3><th>&nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; &nbsp;&nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;&nbsp; TOTAL A PAGAR &nbsp;&nbsp;&nbsp;$<?php echo $prprice2; ?></th></H3>
      </div>
    </div>
    <br>
    <br>
