...
<form class="" method="post" action="./php/process.php">
  <div class="">
  
  </div>
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
    <label for="inputEmail3" class="">Digite correo para confirmar pedido</label>
    <input type="email" name="email" required class="" id="inputEmail3" placeholder="Email del cliente">
...
<a href="https://biz.payulatam.com/B0d33f202045204"><img src="http://www.payulatam.com/img-secure-2015/boton_pagar_mediano.png"></a>
