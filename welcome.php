...
<body>
    <div class="page-header">
        <h1>Hola, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Bienvenido a mactecnologia.com</h1><br>
        <h3>En esta pagina tendras la opcion de CAMBIAR TU CONTRASEÑA cuando lo desees</h3>
